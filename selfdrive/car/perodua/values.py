...
@dataclass
class PeroduaCarInfo(CarInfo):
  package: str = "Perodua Sensing"

  def init_make(self, CP: car.CarParams):
      self.car_parts = CarParts.common([CarHarness.custom])

CAR_INFO: Dict[str, Optional[Union[PeroduaCarInfo, List[PeroduaCarInfo]]]] = {
  CAR.MYVI: [
    PeroduaCarInfo("Perodua Accord 2018-22", "All", video_link="https://www.youtube.com/watch?v=mrUwlj3Mi58"),
    PeroduaCarInfo("Perodua Inspire 2018", "All"),
  ],
  CAR.MYVI_PSD: PeroduaCarInfo("Perodua Accord Hybrid 2018-22", "All")
}
